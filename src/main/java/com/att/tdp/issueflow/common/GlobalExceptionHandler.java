...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiError> handleMaxUploadSize(MaxUploadSizeExceededException ex) {
        return error(HttpStatus.BAD_REQUEST, "Attachment exceeds 10 MB limit", List.of());
    }
